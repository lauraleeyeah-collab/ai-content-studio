...
# ─────────────────────────────────────────────
# 平台工作台（按社交媒体切分）：公众号 / 知乎 / 小红书 专属生产
# ─────────────────────────────────────────────
DEMO_PLATFORM_WORKSHOP = {
    "公众号": {
        "titles": [
            {"title": "我用AI写周报半年，领导从「流水账」到点名表扬，只改了3个提示词", "formula_type": "结果对比型", "rationale": "结果对比制造悬念，数字具体可信，订阅列表一屏内信息完整"},
            {"title": "AI写周报实操指南：给角色设定、喂结构化素材、追加追问，附完整模板", "formula_type": "实操指南型", "rationale": "直接给出可执行路径，信息密度高，符合公众号深度内容偏好"},
            {"title": "被领导夸的周报是怎么写出来的？这套AI工作流值得收藏", "formula_type": "悬念提问型", "rationale": "提问引发好奇，结尾价值暗示引导收藏划线"},
            {"title": "打工人周报自救指南：3个提示词技巧让AI替你写周报", "formula_type": "人群指向型", "rationale": "人群痛点+量化技巧，完读率驱动推荐流量"},
            {"title": "周报总被说像流水账？试试给AI这三个设定", "formula_type": "痛点反问型", "rationale": "痛点开头，反面提醒带出解决方案"},
        ],
        "cover": {
            "subject": "办公桌俯拍：笔记本电脑上AI对话界面生成周报，旁边咖啡与便签，光线自然",
            "style": "真实工作场景摄影感，浅色干净背景",
            "composition": "主体居中偏右，左侧留文字位，头图 2.35:1 横向构图，文字不压人物面部",
            "text_slot": "主标题：AI写周报被点名表扬\n副标题：3个提示词技巧",
            "spec_note": "头图 900×383（2.35:1），标题文字建议右置，正文配图 16:9 截取使用",
        },
        "copy": {
            "content": "你是不是也有这种时刻：周五下午，对着空白文档憋周报，写出来的东西自己都不想看第二遍。\n\n我用AI写周报半年，从被领导说「像流水账」，到最近一次被点名表扬，核心就改了三个地方。\n\n## 一、先给AI一个角色设定\n不要直接说「帮我写周报」。先告诉它：你是一个项目经理，要突出本周进度、风险与下周计划。有了角色，AI输出的结构立刻不一样。\n\n## 二、把素材按结构喂进去\n把本周做的事按「完成/进行中/风险」三类贴给AI。结构化输入决定结构化输出，这一步省掉你 80% 的二次整理。\n\n## 三、追加一次追问\n第一次输出后加一句「把进度量化成百分比，风险给应对方案」。一句话，周报专业度直接拉满。\n\n最后提醒：AI写周报是提效不是代劳，数据和结论务必自己核对。\n\n如果你也被周报折磨，建议先收藏这篇文章，下周五之前照着做一遍。也欢迎在留言区说说你写周报最头疼哪一步，我尽量都回复。",
            "structure_note": "开头3秒钩子（痛点场景）→ 3个小标题分段 → 结尾提醒 + 收藏引导 + 留言互动，符合公众号完读率权重",
        },
        "interaction": {
            "collect_reasons": ["建议收藏，下周五写周报前直接翻出来照着做", "3个提示词模板可复制到自己的场景直接改"],
            "share_guides": ["点个「在看」，转给同样被周报折磨的同事，一起早点下班"],
            "comment_guides": ["你写周报最头疼的是哪一步？留言区聊聊：1素材整理 2措辞表达 3领导看不懂", "有用AI写周报翻车的吗？分享你的坑，我帮你改提示词"],
            "cta_suggestions": ["读完顺手点个「在看」+ 收藏，让这篇指南帮到更多人"],
            "strategy_note": "在看/划线收藏双引导 + 留言互动问题，吃满公众号在看传播与留言加权",
        },
        "topic_angles": [
            {"angle": "工具实操教程：AI写周报的完整提示词工作流", "rationale": "深度教程型，公众号读者愿意为可复用模板停留与收藏"},
            {"angle": "案例拆解：一份被领导表扬的周报长什么样", "rationale": "真实案例拆解，完读率高，适合公众号深度内容"},
            {"angle": "行业观察：AI办公提效进入「效果验证期」，普通职场人怎么跟上", "rationale": "观察型选题，建立账号专业人设，引发转发讨论"},
        ],
    },
    "知乎": {
        "titles": [
            {"title": "如何用AI高效写周报？分享3个实测有效的提示词技巧", "formula_type": "问题型", "rationale": "直接对问题作答，符合知乎搜索与专业内容偏好"},
            {"title": "用AI写周报会被领导发现吗？实测半年的结论是：提效但必须自己核对", "formula_type": "结论先行型", "rationale": "结论先行 + 风险提示，专业且诚实，建立可信人设"},
            {"title": "为什么你的AI周报像流水账？问题出在角色设定这一步", "formula_type": "因果拆解型", "rationale": "指出问题根源，专业分析视角，收藏价值高"},
            {"title": "AI辅助写周报的完整工作流（附提示词模板与避坑清单）", "formula_type": "清单整理型", "rationale": "完整工作流 + 模板，符合知乎收藏导向"},
            {"title": "职场人该不该用AI写周报？我的答案是：用，但别交底稿", "formula_type": "立场表态型", "rationale": "鲜明立场引发赞同与评论区讨论"},
        ],
        "cover": {
            "subject": "信息图风格：AI对话界面 + 周报结构示意图，深色背景高对比",
            "style": "专业信息图，克制配色（深蓝+白），数据感",
            "composition": "头图 16:9，左侧留文字位，信息层级清晰",
            "text_slot": "主标题：AI写周报实操\n副标题：3个提示词技巧",
            "spec_note": "知乎头图 16:9（约 690×388），建议信息图承载核心结论",
        },
        "copy": {
            "content": "结论先说：用AI写周报能显著提效，但输出必须自己核对。我用AI写周报半年，从被领导说「像流水账」到最近一次被点名表扬，核心改了三处。\n\n## 一、给AI设定角色\n直接说「帮我写周报」输出很平。先设定角色：你是一个项目经理，要突出本周进度、风险、下周计划。角色设定决定了输出视角。\n\n## 二、结构化喂素材\n把本周事项按「完成/进行中/风险」分类贴入。AI对结构化输入的处理明显更好，这一步也逼你自己梳理了一遍工作。\n\n## 三、追加追问量化\n第一次输出后追加「把进度量化成百分比，风险给应对方案」。数据化是周报专业度的分水岭。\n\n## 避坑提醒\nAI生成的周报可能夸大进度或遗漏风险，数据与结论务必逐条核对，这既是职业素养，也是保护自己。\n\n## 延伸建议\n如果你所在团队周报有固定模板，把模板结构喂给AI再生成，贴合度会更高。欢迎在评论区交流你的AI写周报经验。",
            "structure_note": "结论先行第一段直接给答案 → 分点论证 → 避坑提醒 → 延伸建议，符合知乎专业内容偏好",
        },
        "interaction": {
            "collect_reasons": ["完整提示词工作流 + 避坑清单，建议收藏随时回看", "实操经验帖，踩过的坑都写出来了，值得保存"],
            "share_guides": ["如果你身边也有写周报头疼的朋友，欢迎转发给TA"],
            "comment_guides": ["你用过AI写周报吗？体验如何，欢迎在评论区分享你的提示词", "被AI周报坑过的举个手，说说发生了什么，我帮你改"],
            "cta_suggestions": ["觉得有用点个赞同 + 收藏，让更多需要的人看到"],
            "strategy_note": "赞同/收藏双引导 + 专业话题评论区交流，沉淀专业人设，吃满知乎专业内容权重",
        },
        "topic_angles": [
            {"angle": "问题式选题：如何用AI高效写周报？（结合真实使用经验）", "rationale": "知乎核心是问题，回答体直接承接搜索流量"},
            {"angle": "避坑向：用AI写周报的常见翻车点与解决方案", "rationale": "避坑内容专业且稀缺，赞同与收藏率高"},
            {"angle": "效率工具深度测评：AI办公提效半年体验报告", "rationale": "长文测评建立专业人设，评论区讨论空间大"},
        ],
    },
    "小红书": {
        "titles": [
            {"title": "用AI写周报被领导点名表扬，我的3个提示词技巧", "formula_type": "结果对比型", "rationale": "结果前置吸引点击，关键词「AI写周报」前置前20字"},
            {"title": "AI写周报｜给AI设个角色，流水账秒变重点周报", "formula_type": "方法速览型", "rationale": "方法+效果一句讲清，适配小红书信息流"},
            {"title": "打工人必存！AI写周报3步法，附提示词模板", "formula_type": "清单收藏型", "rationale": "「必存」暗示收藏价值，符合小红书收藏权重"},
            {"title": "别再让AI直接写周报了！先做这3步，效率翻倍", "formula_type": "反常识型", "rationale": "反常识开头提升点击，正文给方法承接收藏"},
            {"title": "AI周报提示词分享｜领导说我周报比之前专业多了", "formula_type": "效果分享型", "rationale": "人设化表达 + 关键词覆盖，利于搜索流量"},
        ],
        "cover": {
            "subject": "年轻职场女性坐在电脑前，屏幕上是AI生成周报的界面，桌上放着一杯咖啡，明亮办公场景",
            "style": "真实摄影感 + 轻ins风，浅色背景",
            "composition": "人物居中偏右，左侧 1/3 文字位，画面下方留白",
            "text_slot": "主标题：AI写周报被领导表扬\n副标题：3个提示词技巧",
            "spec_note": "封面 3:4 竖版 1080×1440，文字大字高对比，关键词置顶",
        },
        "copy": {
            "content": "如果你还在为每周写周报发愁，这篇直接收藏。我用AI写周报已经半年，从被领导说'像流水账'到被评为'重点周报'，核心就3个提示词技巧。\n\n第一，给AI角色设定。不要直接说'帮我写周报'，先告诉它'你是一个项目经理，要突出本周进度和风险'，输出立刻有重点。\n\n第二，喂结构化素材。把本周做的5件事按'完成/进行中/风险'分类贴进去，AI输出的周报自带逻辑，不用你二次整理。\n\n第三，追加追问。第一次输出后，加一句'把进度量化成百分比，风险给应对方案'，周报的专业度直接拉满。\n\n最后提醒一句：AI写周报是提效不是代劳，数据和结论一定要自己核对。建议收藏，下周写周报前直接翻出来用。",
            "structure_note": "清单体：开头给价值承诺 + 3步实操 + 结尾提醒，符合小红书收藏导向",
        ...
        "interaction": {
            "collect_reasons": ["建议收藏，下周写周报前直接翻出这篇照着做", "3个提示词模板可以直接复制改自己场景用"],
            "share_guides": ["转发给同样被周报折磨的同事，一起早点下班"],
            "comment_guides": ["你写周报最头疼的是哪一步？评论区报个数字：1素材整理 2措辞表达 3领导看不懂", "有没有用过AI写周报翻车的？分享下你的坑，我帮你改提示词"],
            "cta_suggestions": ["建议收藏，下次需要时直接翻出来用"],
            "strategy_note": "收藏理由显性+评论区二选一提问，双管齐下提升收藏率与评论率",
        },
        "topic_angles": [
            {"angle": "真实使用记录：AI写周报3个月，我踩过的坑和总结的技巧", "rationale": "真实记录型是小红书当前流量杠杆，人设可信"},
            {"angle": "场景化教程：用AI做周报/月报/述职的通用提示词模板", "rationale": "场景化工作流可复用，收藏率高"},
            {"angle": "避坑向：AI写周报容易犯的4个错误（附修正提示词）", "rationale": "避坑视角差异化，搜索词覆盖广"},
        ],
    },
}


def _platform_workshop_demo(system_prompt: str, user_prompt: str) -> str:
    """平台工作台演示：从 user_prompt 提取目标平台，返回平台专属生产方案。"""
    import re
    m = re.search(r"「([^」]+)」专属内容方案", user_prompt)
    platform = m.group(1) if m else "小红书"
    data = DEMO_PLATFORM_WORKSHOP.get(platform)
    if data is None:
        data = dict(DEMO_PLATFORM_WORKSHOP["小红书"])
    return json.dumps(data, ensure_ascii=False)
...
_ROUTES = [
    ...
    ("平台工作台", _platform_workshop_demo),     # 平台工作台（按目标平台返回专属方案）
